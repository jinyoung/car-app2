...
pluralCaseList.push( {plural: "policyApplications", pascal: "PolicyApplication"} )

pluralCaseList.push( {plural: "policyStatuses", pascal: "PolicyStatus"} )
pluralCaseList.push( {plural: "policyHistories", pascal: "PolicyHistory"} )
